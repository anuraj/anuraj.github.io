...
![Local DB Info]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/localdb_info.png)
...
![Local DB Info - Running]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/localdb_info.png)

You need to copy the Instance Pipe name and paste it in SSMS Connect to server dialog, like this.

![Local DB - Connect to Server Dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/ssms_connect_to_server.png)
...
![Local DB - Connect to Server Dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/object_explorer_localdb.png)
