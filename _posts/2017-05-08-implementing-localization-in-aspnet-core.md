...
![Add new resource]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/add_new_resource.png)
...
![Hindi Resource file]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/resource_file_for_hindi.png)
...
![Browser rendering on my machine]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/browser_rendering_localized_strings.png)
