...
![MySql Table Query]({{ site.url }}{{ site.baseurl }}/assets/images/2016/08/mysql_table_script.png)

And here is the phpmyadmin console, with Books table data.

![phpmyadmin console]({{ site.url }}{{ site.baseurl }}/assets/images/2016/08/phpmyadmin_console.png)
...
![Database Migrations created]({{ site.url }}{{ site.baseurl }}/assets/images/2016/08/database_migration1.png) 
...
![Database update command]({{ site.url }}{{ site.baseurl }}/assets/images/2016/08/database_migration2.png)
