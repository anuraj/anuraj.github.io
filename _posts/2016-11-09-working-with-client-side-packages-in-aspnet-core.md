...
![Bower Init command for creating bower.json file]({{ site.url }}{{ site.baseurl }}/assets/images/2016/11/bower_init_command.png)
...
![dotnet bundle command running]({{ site.url }}{{ site.baseurl }}/assets/images/2016/11/dotnet_bundle_command.png)
