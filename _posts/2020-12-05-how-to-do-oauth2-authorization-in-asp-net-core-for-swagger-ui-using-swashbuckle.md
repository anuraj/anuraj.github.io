...
![Web API Open API Authorize]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/webapi_openapi_authorize.png)

Click on the Authorize button will display Available authorizations, like the following.

![Available authorizations]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/available_authorizations.png)
...
![AADSTS700051: response_type 'token' is not enabled for the application]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/oauth_token_not_enabled.png)

It is because `Access tokens` and `ID tokens` is not enabled. You can enable it from Authentication menu.

![Authentication - Enable ID Tokens]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/authentication_idtoken.png)
...
![Authentication - Action methods]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/authorize_action.png)
...
![Permission Dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/permission_request.png)
...
![Authentication completed.]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/authentication_completed.png)
