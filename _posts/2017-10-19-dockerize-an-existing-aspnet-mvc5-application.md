...
![Enable the Container feature]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/install_container_feature.png)
...
![Docker Build command output]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/docker_build_command.png)

Now you can run the `docker images` command, which will display all the docker images in your system.

![Docker Images command]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/docker_images.png)
...
![Docker Run command]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/docker_run_command.png)
...
![Docker Inspect command]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/docker_inspect_command.png)

Now you can browse with the IP Address.

![Web App running in Docker]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/webapp_running_in_docker.png)
...
![Add Docker support]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/add_docker_support.png)

This will add a `Dockerfile` and a `docker-compose` project to your solution.

![Solution Explorer with Docker support]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/solution_explorer.png)

Next click on the `docker-compose.yml`, you will be able to see Docker as target for debugging. 

![Docker debug option]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/docker_debug_option.png)
