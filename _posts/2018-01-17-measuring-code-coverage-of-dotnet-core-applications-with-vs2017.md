...
![Code Coverage feature in Visual Studio 2017]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/code_coverage_in_vs2017.png)
...
![Code Coverage results]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/code_coverage_results.png)
...
![Full option - Debugging Information]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/change_debugtype.png)
...
![Code Coverage with Visual Studio 2017]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/code_coverage_in_vs2017_code_only.png)
...
![Code Coverage with vstest.console.exe]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/commandline_coverage.png)
