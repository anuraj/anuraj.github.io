...
![Azure DevOps Build]({{ site.url }}{{ site.baseurl }}/assets/images/2020/01/azure_devops_build.png)
...
![Azure DevOps Build Result]({{ site.url }}{{ site.baseurl }}/assets/images/2020/01/azure_devops_build_result.png)
...
![Azure DevOps Build Updated]({{ site.url }}{{ site.baseurl }}/assets/images/2020/01/azure_devops_build_updated.png)
...
![Azure DevOps Build with Tests]({{ site.url }}{{ site.baseurl }}/assets/images/2020/01/azure_devops_build_tests.png)
