...
![GitHub Actions - New Action]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/github_actions_new.png)
...
![GitHub Actions - ASPNET Core Workflow]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/aspnet_core_workflow.png)
...
![GitHub Actions - ASPNET Core Workflow - Yaml file.]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/aspnet_core_build.png)
...
![GitHub Actions - List of workflows.]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/github_action_workflow_list.png)
...
![dotnet build workflow details.]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/aspnet_workflow_details.png)
