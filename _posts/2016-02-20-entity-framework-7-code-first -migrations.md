...
![EF 7 dnx command]({{ site.url }}{{ site.baseurl }}/assets/images/2016/02/dnx_ef_command.png)
...
![Add migrations command result]({{ site.url }}{{ site.baseurl }}/assets/images/2016/02/add_migrations_initial.png)
...
![Database migrations applied]({{ site.url }}{{ site.baseurl }}/assets/images/2016/02/db_migrations_updated.png)
...
![DbUpdateException]({{ site.url }}{{ site.baseurl }}/assets/images/2016/02/DbUpdateException.png)
...
![Available Code First Migrations]({{ site.url }}{{ site.baseurl }}/assets/images/2016/02/migrations_list.png)
...
![SQL Script]({{ site.url }}{{ site.baseurl }}/assets/images/2016/02/sql_script.png)
