...
![WinAppDriver.exe Running]({{ site.url }}{{ site.baseurl }}/assets/images/2016/06/winappdriver_running.png)
...
![WinAppDriver.exe Running]({{ site.url }}{{ site.baseurl }}/assets/images/2016/06/uwp_package_manifest.png)
...
![UI Automation Test for Calculator UWP App running]({{ site.url }}{{ site.baseurl }}/assets/images/2016/06/uiautomation_of_uwp.gif)
