...
![ASPNET Core MVC Validation]({{ site.url }}{{ site.baseurl }}/assets/images/2019/10/aspnetcore_form_validation.png)
...
![ASPNET Core MVC Validation with Bootstrap Style]({{ site.url }}{{ site.baseurl }}/assets/images/2019/10/aspnetcore_form_validation_bootstrap.png)
