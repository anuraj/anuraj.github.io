...
![Attribute Routing JSON Response]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/attribute_routing_json_response1.png)
...
![Attribute Routing JSON Response - 404 response]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/attribute_routing_json_response_404.png)
...
![Attribute Routing Create method Response]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/attribute_routing_json_response_create.png)
