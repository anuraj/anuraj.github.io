...
![Azure Web App]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/azure_web_app.png)
...
![Custom domain configuration in Azure Web app]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/custom_domain_in_azure_webapp.png)
...
![Custom domain configuration in Azure Web app]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/custom_domain_configure.png)
...
![A NAME record]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/aname_records.png)

6. And next you need to configure TXT records. Here is the screenshot for the same.

![TXT NAME record]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/txt_records.png)
...
![Domain Ownership - Completed]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/domain_ownership.png)

7. Next click on the `Add Hostname` button. This will display the domain name under `Hostname Assigned to Site`.

![Custom domain - Updated]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/custom_domain_updated.png)
