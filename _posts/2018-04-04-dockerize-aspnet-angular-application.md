...
![Docker Build]({{ site.url }}{{ site.baseurl }}/assets/images/2018/04/docker_build.png)

Here is the app running in my machine.

![Running ASP.NET MVC Angular App in Docker]({{ site.url }}{{ site.baseurl }}/assets/images/2018/04/angular_app_running.png)
