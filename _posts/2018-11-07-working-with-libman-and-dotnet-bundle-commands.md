...
![Libman commandline tool]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/libman_help.png)
...
![dotnet build command - Output]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/dotnet_build_command.png)
