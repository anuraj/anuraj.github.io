...
![EF Core - Generating Migrations]({{ site.url }}{{ site.baseurl }}/assets/images/2019/03/migrations_generated.png)
...
![EF Core - Updating Database]({{ site.url }}{{ site.baseurl }}/assets/images/2019/03/database_updated.png)
