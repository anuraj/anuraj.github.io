...
![MongoLab from Azure Marketplace]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/mongolab1.png)
...
![MongoLab - Plan and DB name]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/mongolab2.png)

Next screen will confirm the purchase and creates the Mongo Database on Azure.

![MongoLab - Purchase confirmation]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/mongolab3.png)
...
![MongoLab - Database options]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/mongolab4.png)
...
![MongoLab - Management Portal]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/mongolab6.png)
