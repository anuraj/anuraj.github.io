...
![Smart Unit Tests - Context menu option]({{ site.url }}{{ site.baseurl }}/assets/images/2014/12/smartunittests.png)
...
![Generated Test Data and Test cases]({{ site.url }}{{ site.baseurl }}/assets/images/2014/12/smartunittests2.png)
