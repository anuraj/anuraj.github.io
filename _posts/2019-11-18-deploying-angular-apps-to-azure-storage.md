...
![Static Website Configuration]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/static-website-storage-account.png)
...
![Azure DevOps Build Pipeline]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/angular-ci-buildpipeline.png)
