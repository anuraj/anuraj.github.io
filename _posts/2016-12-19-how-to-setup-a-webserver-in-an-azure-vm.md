...
![Create Azure Virtual Machine]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/azure_create_a_vm.png)
...
![Install IIS from Programs and Features]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/install_iis_on_windows.png)

Once it completed, you need to add exception in firewall to allow incoming / out going traffic. 

![Adding exception to World Wide Web]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/firewall_exception_iis.png)
...
![Network Interfaces menu]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/network_interfaces.png)

From the listed network interfaces, click on the network interface, which will open the Network Security Group. 

![Network Security Group]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/network_security_group_settings.png)
...
![Network Security Group - Inbound Security Rules]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/nsg_inbound_rules.png)

Click add, which will open Add Inbound Rule option.

![Add Inbound Rule]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/add_inbound_rule.png)
...
![Available inbound rules]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/inbound_rules.png)
...
![Webserver running an Azure Virtual Machine]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/webserver_running_on_azure_vm.png)
