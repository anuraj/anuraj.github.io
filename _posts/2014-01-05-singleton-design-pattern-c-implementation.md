...
![Singleton Application running in the console]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/Singleton_v1_console.png)
...
![Singleton running on Multithreaded environment]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/Singleton_v1_Multithreaded.png)
...
![Singleton Multithreaded with lock statement]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/Singleton_v2_Multithreaded.png)
...
![Singleton Multithreaded - with Double-checked locking]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/Singleton_v3_Multithreaded.png)
