...
![Create new Azure App Configuration]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/azure_app_config_create.png)
...
![Create new Azure App Configuration]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/azure_app_config_create_keyvalue.png)
