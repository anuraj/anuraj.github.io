...
![Create Azure Web Jobs]({{ site.url }}{{ site.baseurl }}/assets/images/2019/01/azure_web_job.png)

For the demo post I am using Manual mode. Here is the list of Web Jobs.

![List of Azure Web Jobs]({{ site.url }}{{ site.baseurl }}/assets/images/2019/01/list_webjobs.png)
...
![Web Jobs output]({{ site.url }}{{ site.baseurl }}/assets/images/2019/01/webjob_console_output.png)
