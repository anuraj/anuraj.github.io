...
![GitLab service running on the windows system]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/gitlab_runner_service.png)

You can find the runner in the project runners section.

![GitLab service running on the windows system]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/current_system_runner.png)
...
![GitLab pipeline - Build successfull]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/running_build.png)
