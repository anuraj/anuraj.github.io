...
![Javascript code coverage enabled]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/jscodecoverage.png)
...
![phantomjs output]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/phantomjsoutput.png)
