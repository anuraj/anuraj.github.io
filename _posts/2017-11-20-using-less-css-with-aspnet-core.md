...
![Gulp Command output]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/gulp_command_output.png)
...
![dotnet build Command output]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/dotnet_build_command.png)
