...
![Visual Studio - Un Expected Error]({{ site.url }}{{ site.baseurl }}/assets/images/2013/06/error.png)
...
![Project File as XML]({{ site.url }}{{ site.baseurl }}/assets/images/2013/06/CaptureItPlus6.png)
