...
![C# interactive window]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/csharp_interactive_intro.png)
...
![C# interactive window - Creating functions]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/csharp_interactive_intro.png)
...
![C# interactive window - External Assembly]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/csharp_interactive_external_lib.png)
