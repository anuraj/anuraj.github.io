...
![PWA Registration in Web Page]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/pwa_registration.png)

You can find more details about service worker and manifest from developer tools.

![Progressive Web App enabled for Web App]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/pwa_enabled.png)
...
![InvalidOperationException - IHttpContextAccessor]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/pwa_not_working_exception.png)
