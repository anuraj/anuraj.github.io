...
![dotnet dotCover test command]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/dotcover_command_completed.png)
...
![dotCover coverage report]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/codecoverage_report.png)
