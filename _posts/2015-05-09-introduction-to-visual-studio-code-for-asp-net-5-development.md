...
![Visual Studio Code]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/vscode.png)
...
![NuGet reference management in project.json]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/project.json2_.png)
...
![Prompting for nuget package restore]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/project.json1_.png)

Here is the CSS - Intellisense using VS Code

![CSS - Intellisense]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/css.png)
...
![Javascript - Add reference of JQuery]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/javascript.png)

VS Code also support Bower.json intellisense.

![Bower JSON - Intellisense]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/bowerjson.png)

VS Code supports Visual Studio features like Peek Definition.

![Peek Definition - VS Code]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/peekdef.png) 

VS Code also supports running ASP.NET commands like dnu restore, dnx . web etc.

![Execute dnx commands]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/executecommands.png)
