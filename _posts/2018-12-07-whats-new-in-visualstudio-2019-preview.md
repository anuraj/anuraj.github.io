...
![Visual Studio 2019 Preview Splash]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/visualstudio2019_splash.png)

Next change the startup screen, unlike the usual IDE layout and screen, it is changed and will look like this.

![Visual Studio 2019 First Screen]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/vs2019_first_screen.png)
...
![Clone or Checkout Option]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/clone_or_checkout_option.png)

This will clone the repo and open the project in Visual Studio. Another change is `Create New Project` option.

![Create new project screen]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/create_new_project.png)
...
![Visual Studio 2019 IDE]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/visualstudio2019.png)
...
![Visual Studio 2019 Search]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/visualstudio2019_search.png)
...
![Visual Studio 2019 Search]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/vs2019_code_cleanup.png)
...
![Visual Studio IntelliCode]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/intellicode_model.png)
