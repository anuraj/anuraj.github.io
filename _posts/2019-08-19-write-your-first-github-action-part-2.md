...
![NuGet.org API Key]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/nuget_api_key.png)
...
![API Key in GitHub Secrets]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/github_secrets.png)
...
![NuGet deployment]({{ site.url }}{{ site.baseurl }}/assets/images/2019/08/nuget_deployment.png)
