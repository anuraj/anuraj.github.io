...
![Create Knowledgebase — Azure QnA Maker]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/create-kb.png)
...
![Create QnA Service — Azure Portal]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/qnamaker-provision.png)
...
![Connect QnA Service to Knowledgebase]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/create-kb-step2.png)
...
![Populate Knowledgebase with data from FAQ Pages]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/create-kb-step4.png)
...
![Populated Knowledgebase]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/kb-test.png)
...
![Publish Knowledgebase to consume it in services and bot framework.]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/kb-publish.png)
...
![Published knowledgebase]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/kb-published.png)
...
![Web App Bot — Azure]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/webapp-bot.png)
...
![Testing Bot with Web Chat option.]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/test-in-web-chat.png)
...
![Zoom — COVID 19 Faq Bot]({{ site.url }}{{ site.baseurl }}/assets/images/2020/06/zoom-bot.png)
