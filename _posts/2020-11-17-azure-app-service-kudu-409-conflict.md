...
![Kudu Error]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/kudu-error.png)
...
![Azure App Service Configuration]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/app_service_config.png)
