...
![ASP.NET Web API Request without header]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/api_request_no_header.png)

Now you can generate the token using Token endpoint with the username and password, which will generate the token.

![Generating token with token endpoint]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/token_generation_endpoint.png)
...
![ASP.NET Web API Request with header]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/api_request_with_header.png)
