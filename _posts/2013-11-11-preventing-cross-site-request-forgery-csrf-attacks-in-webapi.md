...
![Requesting a web page with Forms authentication]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/loadpage1.png)
2.  Browser is redirecting to the login page, and gets the login page.
![Browser redirecting to login page]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/loginpage.png)
3.  User authenticating with the credentials, sending a POST request.
![credentials send a POST request for authentication]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/loginwithcredentials.png)
4.  Server authenticates the user and Forms authentication cookie is set.
![Server Authenticated the user and cookie is set]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/cookieset.png)
...
![POST request to Web API]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/post1.png)
...
![POST request to WebAPI without authentication]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/post2.png)
...
![POST request with RequestVerification header]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/post_with_anti.png)
...
![POST request without RequestVerification header]({{ site.url }}{{ site.baseurl }}/assets/images/2013/11/post_without_anti.png)
