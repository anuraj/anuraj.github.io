...
![Google Developers Console - Push Notification enabled]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/gcm_console.png)
...
![Modify existing Android Virtual Device]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/modify_avd.png)
...
![Add Google Account in the emulator]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/add_google_account.png)
...
![Key for server applications]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/Key_for_server_applications.png)
...
![Push Notification received in the emulator]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/pushnotification_in_emulator.png)
