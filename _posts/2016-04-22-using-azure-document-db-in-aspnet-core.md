...
![Azure Document DB - Create Account]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/azure_document_db_create.png)
...
![Azure Document DB - Keys]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/azure_document_db_keys.png)
...
![Azure Document DB - Document Explorer]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/azure_document_db_document_explorer.png)
