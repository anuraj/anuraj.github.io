...
![Postman - HTTP Request with application/xml accept header]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/postman_web_api_request_with_xml.png)
...
![Postman - HTTP Request with application/xml accept header with XML Response]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/postman_web_api_request_with_xml2.png)
