...
![POST Request without Anti-forgery Token]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/post_request_without_token.png)
...
![Cookies created by ASP.NET Core Web API]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/cookies_aspnetcore.png)

Next any request from Angular, you will be able to see the `X-XSRF-TOKEN`.

![Angular sending X-XSRF-TOKEN header]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/angular_header.png)
