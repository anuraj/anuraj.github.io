...
![Enable NuGet Package Restore option]({{ site.url }}{{ site.baseurl }}/assets/images/2013/10/enps.png)

This will show up a confirmation message like this. 

![Enable NuGet Package Restore Confirmation]({{ site.url }}{{ site.baseurl }}/assets/images/2013/10/confirm.png)

Once you accepts it, Visual Studio will add a .nuget folder to the solution, you need to check in the solution to TFS.

![.NuGet folder in solution explorer]({{ site.url }}{{ site.baseurl }}/assets/images/2013/10/nuget_folder.png)
...
![Build - Output Window]({{ site.url }}{{ site.baseurl }}/assets/images/2013/10/output_window.png)
