...
![Build Pipeline]({{ site.url }}{{ site.baseurl }}/assets/images/2019/02/build_pipeline.png)
...
![Deployed Web Job in the portal]({{ site.url }}{{ site.baseurl }}/assets/images/2019/02/deployed_webjob.png)
