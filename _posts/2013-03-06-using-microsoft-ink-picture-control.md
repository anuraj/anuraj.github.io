...
![Select Mode in InkPicture control]({{ site.url }}{{ site.baseurl }}/assets/images/2013/03/CaptureItPlus2.png)
...
![Custom Hatch brush drawing in InkPicture control]({{ site.url }}{{ site.baseurl }}/assets/images/2013/03/CaptureItPlus21.png)
