...
![Web API Open API support]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/vs_openapi_new_project.png)
...
![Azure App Service]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/create_web_app_az_asp5.png)
