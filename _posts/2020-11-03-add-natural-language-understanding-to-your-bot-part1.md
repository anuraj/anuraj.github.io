...
![Create LUIS app]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/create_luis_account.png)
...
![Create LUIS app]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/create_luis_app.png)
...
![Add Notes Prebuilt domain]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/add_domain_luis.png)
...
![Test the Prebuilt domain]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/luis_app_test.png)
...
![Publish Luis]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/publish_luis.png)
...
![Add a Prediction resource]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/add_prediction_resource.png)
