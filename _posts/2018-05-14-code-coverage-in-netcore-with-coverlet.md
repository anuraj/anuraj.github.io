...
![Code coverage Console output]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/code_coverage_result.png)
...
![Code coverage Report]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/code_coverage_gen.png)
...
![Code coverage with Threshold]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/code_coverage_threshold.png)
...
![SonarCloud dashboard with Code Coverage]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_dashboard_with_cc.png)
