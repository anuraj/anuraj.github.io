...
![Add Connected Service Dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/add_connected_service.png)
...
![Configure WCF Service Reference Dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/configure_wcf_service_reference.png)
