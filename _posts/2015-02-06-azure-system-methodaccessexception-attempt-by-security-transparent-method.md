...
![System.MethodAccessException: Attempt by security transparent method]({{ site.url }}{{ site.baseurl }}/assets/images/2015/02/server_error.png)

This issue was resolved by changing the file publish options.

![File Publish Options]({{ site.url }}{{ site.baseurl }}/assets/images/2015/02/publishsettings.png)
