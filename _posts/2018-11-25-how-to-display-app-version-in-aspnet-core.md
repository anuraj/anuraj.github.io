...
![App version display]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/app_version_display.png)
...
![Azure DevOps - Build Options]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/azure_devops_build_options.png)
