...
![Folder structure]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/folder_structure.png)
...
![dotnet test - results]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/dotnet_test_results.png)
