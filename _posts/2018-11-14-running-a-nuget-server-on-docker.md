...
![BaGet NuGet server running locally]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/baget_nuget_server.png)
...
![BaGet NuGet server - Package]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/baget_nuget_server_with_package.png)
