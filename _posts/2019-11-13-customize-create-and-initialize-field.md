...
![Visual Studio - Quick Refactoring]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/visual_studio_create_field.png)
...
![Visual Studio - Quick Refactoring]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/naming_style.png)

Next click on the managing naming styles button. Then click on the Green Plus sign. And add the following details.

![Visual Studio - Manage Naming Styles]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/naming_style_new.png)
...
![Visual Studio - Manage Naming Styles]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/naming_style_final.png)
...
![Visual Studio - Manage Naming Styles - Updated]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/visual_studio_create_field_fix.png)
