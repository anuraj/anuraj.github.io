...
![MVC - Solution Explorer]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/mvc_solution_explorer.png)
...
![ng new command]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/ng_new_command.png)

Here is the updated folder structure after creating the Angular project.

![MVC - With Angular project]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/mvc_solution_explorer_angular.png)
...
![Modified Angular cli json file]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/angularcli_json_file.png)

Next you need to run `ng build` command. Once you run the command, it will generate required files to the bundles folder.

![ng build command]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/ng_build_command.png)
...
![angular-cli.json Styles and Script reference]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/angularcli_json_ref.png)
...
![ng build command]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/ng_build_command_no_css.png)
...
![ng build command with -ec parameter]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/ng_build_command_css.png)
...
![ng build command with --prod parameter]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/ng_build_command_prod.png)
...
![ng build command output in Visual Studio]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/ng_build_in_vs_output.png)

That's it. Now you can add modules and components to angular application and you can debug it with chrome developer tools.

![Debugging Web app]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/angular_web_debug.png)
