...
![EF Core generated code for creating table]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/migrations_script.png)
...
![EF Core Database Update command output]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/efcore_database_update.png)
