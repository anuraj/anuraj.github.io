...
![VB.NET ASP.NET Core Web App running.]({{ site.url }}{{ site.baseurl }}/assets/images/2017/09/dotnet-run-command.png)
...
![The view Index was not found.]({{ site.url }}{{ site.baseurl }}/assets/images/2017/09/view-index-not-found.png)
