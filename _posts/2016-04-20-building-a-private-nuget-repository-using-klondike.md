...
![Klondike running in your local environment]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/Klondike_running_iis_website.png)
...
![Nuget Push command]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/nuget_push_command.png)
...
![Packages details in Klondike packages]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/Klondike_packages.png)
...
![Configuring local package source]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/configuring_local_package_source.png)
...
![Manage Nuget Packages for solution]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/Manage_Nuget_Packages_for_this_solution.png)
