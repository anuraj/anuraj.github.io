...
![Create new Facebook application]({{ site.url }}{{ site.baseurl }}/assets/images/2013/07/Create_New_FB_app.png)

And you can get the App ID/API Key and App Secret, by clicking on the App details page.
![Facebook Application details]({{ site.url }}{{ site.baseurl }}/assets/images/2013/07/FB_App_Details.png)
...
![Facebook Authentication Dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2013/07/Authentication_dialog.png)
...
![Authorization dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2013/07/Authorization_dialog.png)
...
![Uploaded File - From Facebook timeline]({{ site.url }}{{ site.baseurl }}/assets/images/2013/07/Uploaded_File.png)
