...
![Mongod.exe is running and waiting for connections]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/mongodb_running.png)
...
![Mongo DB - Database and Collection using RoboMongo]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/Robomongo_ConnectedToDB.png)
