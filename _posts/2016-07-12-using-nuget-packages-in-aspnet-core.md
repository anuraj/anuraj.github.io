...
![dotnet pack command and result]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/dotnet_pack_command_result.png)
...
![Nuget Package Manager]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/nuget_package_manager.png)
