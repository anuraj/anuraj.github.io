...
![ASP.NET Core MessagePack Formatter]({{ site.url }}{{ site.baseurl }}/assets/images/2018/09/aspnetcoremvcformatter_package.png)
...
![ASP.NET Core MessagePack Output]({{ site.url }}{{ site.baseurl }}/assets/images/2018/09/messagepack_package_output.png)
