...
![Enable C# 8.0 features]({{ site.url }}{{ site.baseurl }}/assets/images/2019/05/enable_cs8_features.png)
...
![Method not implemented error]({{ site.url }}{{ site.baseurl }}/assets/images/2019/05/not_implemented_error.png)
