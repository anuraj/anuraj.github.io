...
![Sonar Qube with Embedded  Database]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/sonarwithembeddb.png)
...
![SQL Server protocol configuration]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/sqlconfig.png)
...
![Modify TCP/IP properties]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/tcpipproperties.png)
...
![Sonar Qube connected with SQL Server]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/sonarwithSql.png)
