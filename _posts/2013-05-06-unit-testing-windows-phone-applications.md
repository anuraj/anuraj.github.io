...
![Windows Phone Unit Test App - Project Template]({{ site.url }}{{ site.baseurl }}/assets/images/2013/05/CaptureItPlus8.png)
...
![Windows Phone Unit Test App - Project References]({{ site.url }}{{ site.baseurl }}/assets/images/2013/05/CaptureItPlus10.png)
...
![Running Windows Phone Unit Tests from VS 2012 IDE]({{ site.url }}{{ site.baseurl }}/assets/images/2013/05/CaptureItPlus12.png)
