...
![Docker images - Output]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/docker_images.png)
...
![Docker images - After tagging]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/docker_images_after_tagging.png)
...
![Docker Push command]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/docker_push_command.png)

Once it is completed, you can login to your docker hub and you will be able to see the image.

![Docker Images in Docker Hub]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/docker_images_in_hub.png)
...
![Docker Hub - Select GitHub Repo]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/automated_build_select_repo.png)
...
![Docker Hub automated build options]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/automated_build_options.png)
...
![Docker Automated Build Results]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/dockerhub_automated.png)
...
![GitHub WebHook settings]({{ site.url }}{{ site.baseurl }}/assets/images/2018/11/github_webhook.png)
