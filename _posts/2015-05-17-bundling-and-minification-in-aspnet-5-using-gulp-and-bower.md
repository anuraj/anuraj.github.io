...
![Hello World using Gulp]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/gulphello.png)
...
![Bower Init command]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/bowerfile.png)
...
![Bower install - Bootstrap]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/bowerinstall.png)
