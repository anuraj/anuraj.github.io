...
![Create an Azure VM using Ubuntu 14.04 LTS Quick Create option]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/create_azure_linux_vm.png)

And you need to add Remote Desktop endpoint using end points option. Here is the list of endpoints the VM created.

![List of Remote Desktop endpoints]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/remote_desktop_endpoint.png)
...
![List of Remote Desktop endpoints]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/linux_virtual_machine.png)
