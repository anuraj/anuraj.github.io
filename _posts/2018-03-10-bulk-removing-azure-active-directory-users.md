...
![Azure Active Directory - Tenant Id]({{ site.url }}{{ site.baseurl }}/assets/images/2018/03/azure_tenant_id.png)
...
![Connect-AzureAD command response]({{ site.url }}{{ site.baseurl }}/assets/images/2018/03/connect_azure_ad.png)
