...
![Creating Azure Function App]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/create_function.png)
...
![Blob trigger function.]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/blob_storage_trigger_function.png)
...
![Azure Storage Extension prompt.]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/azure_storage_extension.png)
...
![New Function dialog.]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/new_function.png)
...
![Function running and logged into the console.]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/function_running.png)
...
![New Output binding]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/azure_storage_output.png)
