...
![Http Post block with the request value]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/http_post_block.png)

But it is failed after 4 tries.

![Http Post block with the request value]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/http_post_block_failed.png)
...
![Create Request using Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/postman_request.png)

It is working and I got the JSON result, now you can get the code using 

![HTTP Request Code generated by Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/http_code_generated.png)
...
![HTTP Block modified]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/http_post_block_modified.png)

Now you can navigate to overview page and run trigger again and post a tweet with Hashtag to see it in action.

![HTTP Block executed successfully]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/http_post_block_completed.png)
