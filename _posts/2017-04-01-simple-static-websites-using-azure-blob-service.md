...
![Create Storage Account - Blade]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/new_blob_storage.png)
...
![Create new container]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/create_container.png)
...
![Uploading files to the container]({{ site.url }}{{ site.baseurl }}/assets/images/2017/04/upload_file_to_container.png)
