...
![XUnit Test Results ]({{ site.url }}{{ site.baseurl }}/assets/images/2014/12/ktest1.png)
...
![XUnit MVC Test Results]({{ site.url }}{{ site.baseurl }}/assets/images/2014/12/xunitmvcresults.png).
