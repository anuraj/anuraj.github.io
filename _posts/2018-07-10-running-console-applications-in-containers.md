...
![Docker build]({{ site.url }}{{ site.baseurl }}/assets/images/2018/07/docker_build_command.png)
...
![IP Config]({{ site.url }}{{ site.baseurl }}/assets/images/2018/07/ipconfig_command.png)
...
![Docker Logs]({{ site.url }}{{ site.baseurl }}/assets/images/2018/07/hangfire_running_on_docker.png)
