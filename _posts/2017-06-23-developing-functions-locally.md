...
![New Azure Functions project]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/new_project_azure_functions.png)
...
![Azure Functions Template]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/azure_function_template.png)
...
![Azure Functions CLI running]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/azure_function_cli_debugging.png)

Now you can open postman, and send the request to "http://localhost:7071/api/HttpTriggerCSharp"

![Azure Functions - Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/azure_function_postman.png)
...
![Azure Functions - Publish option]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/azure_function_publish.png)
