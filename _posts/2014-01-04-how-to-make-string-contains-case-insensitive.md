...
![Unit Tests - string.Contains method]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/String_Contains_Test.png)
...
![Modified unit tests ]({{ site.url }}{{ site.baseurl }}/assets/images/2014/01/Modified_string_tests.png)
