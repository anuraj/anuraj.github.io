...
![Linking Travis CI and GitHub]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/travisci_init.png)
...
![Travis CI build output]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/build-output.png)
...
![build status image from Travis CI]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/build-status.png)
