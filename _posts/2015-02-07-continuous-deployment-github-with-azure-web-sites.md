...
![Set up deployment from source control]({{ site.url }}{{ site.baseurl }}/assets/images/2015/02/setup_source_control.png)

Now select GitHub from the list.

![GitHub from Source code repository list]({{ site.url }}{{ site.baseurl }}/assets/images/2015/02/setup_github.png)
...
![Select GitHub repository]({{ site.url }}{{ site.baseurl }}/assets/images/2015/02/select_source_repo.png)
...
![Integrating application insight code to HTML Page]({{ site.url }}{{ site.baseurl }}/assets/images/2015/02/changes.png)
...
![Deployments Tab in Azure portal ]({{ site.url }}{{ site.baseurl }}/assets/images/2015/02/autodeploy.png)
