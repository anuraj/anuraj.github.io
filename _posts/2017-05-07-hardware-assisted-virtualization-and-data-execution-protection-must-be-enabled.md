...
![Hardware assisted virtualization and data execution protection must be enabled in the BIOS]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/Hardware_assisted_virtualization_and_data_execution_protection.png)
