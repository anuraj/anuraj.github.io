...
![Bundle output - Folder structure]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/folderstructure.png)
...
![Remote site folder structure]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/remotesite.png)
...
![ASP.NET 5 - Hosting in IIS]({{ site.url }}{{ site.baseurl }}/assets/images/2015/04/hostinginiis.png)
