...
![dotnet command output]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/dotnet_info.png)

Here is screencast of the same.

![dotnet command output]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/dotnetcore3inlinux.gif)
