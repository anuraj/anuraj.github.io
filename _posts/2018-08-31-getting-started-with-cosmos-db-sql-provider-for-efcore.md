...
![Cosmos DB SQL NuGet package]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/cosmosdb_nuget.png)
...
![Cosmos DB Emulator is running]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/cosmosdb_emulator.png)
...
![Postman - HTTP Post]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/postman_httppost.png)

And here is the data in Cosmos DB Emulator.

![Data in Cosmos DB Emulator]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/cosmosdb_explorer.png)
