...
![Network without Sprite image]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/network_without_sprites.png)
...
![Network with Sprite image]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/network_with_sprite.png)
