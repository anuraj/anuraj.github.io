...
![Azure App Service - Static website enabled]({{ site.url }}{{ site.baseurl }}/assets/images/2020/01/static_website_enabled.png)
...
![Blazor app running on Azure Storage Account]({{ site.url }}{{ site.baseurl }}/assets/images/2020/01/blazor_app_storage_account.png)

While running the application, if you see any error like this.

![Mono.wasm content type error]({{ site.url }}{{ site.baseurl }}/assets/images/2020/01/blazor_app_storage_account_error.png)
