...
![Open API support for Web API]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/webapi_openapi.png)
...
![Version parameter removed]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/version_parameter_removed.png)
...
![Version added to URL]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/version_added_to_url.png)
...
![Web API with Open API and Versioning support]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/webapi_version_openapi.png)
