...
![Installing Chrome Extension]({{ site.url }}{{ site.baseurl }}/assets/images/2014/03/chromeextns.png)
...
![Pack Extension Dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2014/03/packextn.png)
...
![Add Extension - Confirmation]({{ site.url }}{{ site.baseurl }}/assets/images/2014/03/installextn.png)

Click on the Add button. Once it is added successfully, it will be displayed in the extensions tab.

![Extension Installed Successfully]({{ site.url }}{{ site.baseurl }}/assets/images/2014/03/installed.png)

To see the extension in action, select a word, and right click you can see a context menu item like this.

![Extension in Action]({{ site.url }}{{ site.baseurl }}/assets/images/2014/03/context_menu.png)
