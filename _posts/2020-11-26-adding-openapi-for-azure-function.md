...
![Azure Function running]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/azure_function_running.png)
...
![Open API Specification]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/open_api_spec.png)
...
![Open API Specification with Open API operation]({{ site.url }}{{ site.baseurl }}/assets/images/2020/11/open_api_spec2.png)
