...
![dotnet new template - folder structure]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/folder_structure.png)
...
![dotnet new -l - available project templates]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/dotnet_new_l_command.png)
...
![Template cache file]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/template_cache_file.png)
