...
![Add Chrome configuration in launch.json]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/chrome_configuration.png)
...
![Debugging configuration selection in VSCode]({{ site.url }}{{ site.baseurl }}/assets/images/2018/01/VSCode_select_debug_config.png)
