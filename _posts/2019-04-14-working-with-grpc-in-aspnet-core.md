...
![gRPC project template]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/grpc_project_template.png)

Once you create a gRPC app, you will get two projects - one server project and one client project.

![gRPC Application]({{ site.url }}{{ site.baseurl }}/assets/images/2019/04/grpc_project_app.png)
