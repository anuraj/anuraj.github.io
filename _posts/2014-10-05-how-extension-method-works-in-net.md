...
![Extension Attribute in IL Code]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/extensionattribute.png)

And in the consuming code, it is like invoking a static method.

![IL Main - Invoking static method]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/invoke.png)
