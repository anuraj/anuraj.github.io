...
![Create an Azure Function]({{ site.url }}{{ site.baseurl }}/assets/images/2016/09/new_azure_functions.png)
...
![Azure Function templates]({{ site.url }}{{ site.baseurl }}/assets/images/2016/09/azure_function_template.png)

4. Once you create the function, you will be redirected to the Develop tab, where you can write code for your function. 

![Azure Function Develop Tab]({{ site.url }}{{ site.baseurl }}/assets/images/2016/09/azure_function_develop.png)
...
![Testing the azure function]({{ site.url }}{{ site.baseurl }}/assets/images/2016/09/azure_function_testing.png)
...
![Testing the azure function using Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2016/09/testing_azure_function_using_postman.png)
