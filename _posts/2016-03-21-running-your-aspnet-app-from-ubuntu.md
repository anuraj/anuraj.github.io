...
![DNX Web Command running on Ubuntu Terminal]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/dnx_web_command.png)
...
![Endpoint configuraion on Azure Linux VM]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/http_endpoint_azure_linux_vm.png)
