...
![Apps for office]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/ReadMailAddin1.png)

+ From the next Wizard step, since we are creating an outlook addin from the next step you need to select the mail option.
![Mail application]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/ReadMailAddin2.png)
...
![Read Form]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/ReadMailAddin3.png)
...
![HTTPS url of the web application]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/httpsurl.png)
...
![Connect to Office 365 mail account]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/StartDeployment.png)
...
![Add in installed on the outlook web app.]({{ site.url }}{{ site.baseurl }}/assets/images/2015/12/officeAppAddinInstalled.png)
