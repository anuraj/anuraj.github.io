...
![OData package in Nuget]({{ site.url }}{{ site.baseurl }}/assets/images/2018/07/odata_reference_nuget.png)
...
![OData metadata]({{ site.url }}{{ site.baseurl }}/assets/images/2018/07/odata_metadata.png)
...
![OData Post data using Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2018/07/postman_odata.png)
...
![OData Query with Filters using Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2018/07/odata_query.png)
