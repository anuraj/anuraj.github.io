...
![Health endpoint]({{ site.url }}{{ site.baseurl }}/assets/images/2020/07/health_endpoint.png)
...
![Health endpoint with DbContext]({{ site.url }}{{ site.baseurl }}/assets/images/2020/07/health_endpoint2.png)
...
![Health endpoint with DbContext]({{ site.url }}{{ site.baseurl }}/assets/images/2020/07/health_endpoint3.png)
