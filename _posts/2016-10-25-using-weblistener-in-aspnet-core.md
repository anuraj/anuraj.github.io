...
![WebListener 1.0.0 stable version announcement]({{ site.url }}{{ site.baseurl }}/assets/images/2016/10/weblistener_announcement.png)
...
![WebListener server name]({{ site.url }}{{ site.baseurl }}/assets/images/2016/10/server_name.png)
