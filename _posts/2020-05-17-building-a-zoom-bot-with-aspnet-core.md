...
![Install Zoom Bot for testing]({{ site.url }}{{ site.baseurl }}/assets/images/2020/05/install_bot_zoom.png)
...
![Zoom Authorize Tab]({{ site.url }}{{ site.baseurl }}/assets/images/2020/05/zoom_auth_window.png)

Once authorization is successful, it will launch the Zoom app with Bot in the chat window.

![Zoom app with Bot]({{ site.url }}{{ site.baseurl }}/assets/images/2020/05/zoom_chatbot.png)
...
![Message Payload]({{ site.url }}{{ site.baseurl }}/assets/images/2020/05/zoom_payload.png)
...
![Echo bot on Zoom]({{ site.url }}{{ site.baseurl }}/assets/images/2020/05/echo_bot_on_zoom.png)
