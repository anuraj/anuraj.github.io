...
![Sonar Cloud Dashboard]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_dashboard.png)

Next you need to create an Organization. 

![Create Organization]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/create_new_org_sonar.png)
...
![Choose Organization]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_wizard_screen1.png)

Next, you need to generate token, which will be used to run the code analysis, make sure you store it safe.

![Token Generation]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_wizard_screen2.png)

And in the third screen, you need select the target language and provide a project key. 

![Project details]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_wizard_screen3.png)

Clicking on Done, SonarCloud will show the steps to run code analysis using MSBuild. 

![Sonar scanner for MS Build details]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_wizard_screen4.png)
...
![dotnet sonar scanner command]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/dotnet_sonarscanner.png)

Next you need to build the application using `dotnet build` command. You will be able to see some warnings in the screen.

![dotnet build command]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/dotnet_build.png)
...
![Sonar Cloud Dashboard]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_dashboard2.png)
...
![After applying filters]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/sonarcloud_dashboard3.png)
