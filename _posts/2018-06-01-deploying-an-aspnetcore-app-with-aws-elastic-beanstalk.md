...
![Creating a new AWS Elastic Beanstalk App]({{ site.url }}{{ site.baseurl }}/assets/images/2018/06/create_web_app_aws.png)

And for application code I choose `Upload your code` option.

![Uploading App]({{ site.url }}{{ site.baseurl }}/assets/images/2018/06/upload_code.png)

Both Uploading and deployment will take sometime.

![AWS Environment getting created]({{ site.url }}{{ site.baseurl }}/assets/images/2018/06/aws_environment_creating.png)
...
![Deployment completed]({{ site.url }}{{ site.baseurl }}/assets/images/2018/06/deployment_completed.png)
...
![ASP.NET Core 2.1 app running in AWS]({{ site.url }}{{ site.baseurl }}/assets/images/2018/06/aspnet_app_running.png)
