...
![dotnet global tool running]({{ site.url }}{{ site.baseurl }}/assets/images/2018/03/dotnet_global_tool.png)
...
![dotnet pack command]({{ site.url }}{{ site.baseurl }}/assets/images/2018/03/dotnet_pack.png)
...
![dotnet install command]({{ site.url }}{{ site.baseurl }}/assets/images/2018/03/dotnet_install.png)

Once installation is successful, you can run the `banner` command to execute the tool.

![dotnet tool running]({{ site.url }}{{ site.baseurl }}/assets/images/2018/03/dotnet_tool_running.png)
