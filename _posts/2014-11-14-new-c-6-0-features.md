...
![IL code generated for nameof operator]({{ site.url }}{{ site.baseurl }}/assets/images/2014/11/ILCodegenerated1.png)
...
![null conditional dot operator - with value types]({{ site.url }}{{ site.baseurl }}/assets/images/2014/11/code2.png)
...
![String Interpolation - IntelliSense ]({{ site.url }}{{ site.baseurl }}/assets/images/2014/11/code3.png)
