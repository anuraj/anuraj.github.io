...
![Swagger api page]({{ site.url }}{{ site.baseurl }}/assets/images/2016/06/swaggergen_api_page.png)
...
![Generate xml documentation]({{ site.url }}{{ site.baseurl }}/assets/images/2016/06/generate_xm_documentation.png)
