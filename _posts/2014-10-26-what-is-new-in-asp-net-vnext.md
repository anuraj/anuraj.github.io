...
![New vNext Empty Web Application]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/newvnextproject.png)
...
![Solution Explorer with vNext Files]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/solutionexplorer.png)
...
![Active Target Framework is ASP.Net ]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/aspnetframework.png)

    **Active Target Framework is ASP.Net Core**

![Active Target Framework is ASP.Net Core ]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/aspnetcoreframework.png)
...
![Intellisense in Project.json for packages]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/projectjsonintelli.png)

![Intellisense in Project.json for package version as well]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/projectjsonintelli2.png)
...
![Solution Explorer - With Controllers and Views]({{ site.url }}{{ site.baseurl }}/assets/images/2014/10/solutionexplorerwithfiles.png)
