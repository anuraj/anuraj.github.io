...
![Azure AD App Registration]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/new_app_registration.png)
...
![Add Scope]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/addscope.png)
...
![Add Scope]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/addscope2.png)
...
![Platform configurations]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/platform_configuration.png)
...
![Generate Client Secret]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/postman_client.png)
...
![Postman Authorization]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/postman_client2.png)
...
![Token from Azure AD]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/token_from_azure_ad.png)
...
![Postman with Authorization header]({{ site.url }}{{ site.baseurl }}/assets/images/2020/12/postman_execute_auth.png)
