...
![Create Azure DNS Zone]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/create_azure_dns.png)
...
![Azure DNS - Name Server Details]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/domain_name_server.png)
...
![DNS Lookup command results]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/dnslookup_result.png)
...
![Add Record Set]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/add_record_set.png)

You need to add `@` and `*` with type `A` and point to the VM's IP Address. Here is the final output.

![Adding Record Set]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/adding_record_set.png)
