...
![SonarCube - running]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/SonarCube.png)

You can also open http://localhost:9000, to verify SonarCube is running or not.You will find something like this.

![SonarCube Web Portal]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/SonarCube_web.png)
...
![Sonar Runner - System variables]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/SonarRunner.png)
...
![SonarRunner Help command]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/SonarRunner_help.png)
...
![SonarCube - Update Center - Available Plugins]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/UpdateCenter.png)
...
![SonarCube - Restart the server after plugin installation]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/restart_server.png)
...
![SonarRunner - Analysis Completed]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/SonarRunner_Completed.png)

Once the analysis completes, you can see the analysis results in the Sonarcube webportal.

![SonarCube Analysis Results on WebPoral]({{ site.url }}{{ site.baseurl }}/assets/images/2015/05/SonarWeb_Results.png)
