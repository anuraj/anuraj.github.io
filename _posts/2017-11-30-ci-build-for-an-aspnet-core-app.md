...
![Create new project VSTS]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/new_project_vsts.png)

Then connect the project in Visual Studio, add the solution to source control.

![Add the project to VSTS]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/project_added.png)
...
![Choose Template - VSTS]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/choose_template.png)
...
![Modify build steps]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/dotnet_tool_2.png)
...
![Queue new build]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/queue_new_build.png)
...
![Queue new build]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/running_build.png)
