...
![Bad Request Error without any version in the request]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/no_version_specified.png)
...
![API Versions reporting]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/report_api_versions.png)
...
![Response Headers]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/postman_response.png)
