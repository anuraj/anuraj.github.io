...
![Fiddler - POST request with Invalid Email address]({{ site.url }}{{ site.baseurl }}/assets/images/2013/09/fiddler_compose.png)

And here is the response from Web API Service, in Fiddler.

![Service response in Fiddler]({{ site.url }}{{ site.baseurl }}/assets/images/2013/09/fiddler_response.png)
