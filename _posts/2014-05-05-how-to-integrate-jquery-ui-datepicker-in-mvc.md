...
![JQuery UI DateTime Picker in MVC]({{ site.url }}{{ site.baseurl }}/assets/images/2014/05/datetimepicker.png)
...
![JQuery UI DateTime Picker in MVC - Date Validation fails]({{ site.url }}{{ site.baseurl }}/assets/images/2014/05/datetimepicker2.png)
