...
![Slack API Credentials]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/slack_api_credentials.png)
...
![Slack Sign In Dialog with Team Selection]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/slack_signin_team_dialog.png)

Once user's team selection completed, the authentication dialog will be presented with username and password fields.

![Slack Sign In Dialog with Credentials]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/slack_signin_user_dialog.png)
...
![Web Application with logged in Name]({{ site.url }}{{ site.baseurl }}/assets/images/2016/07/mvc_app_with_slackauth.png)
