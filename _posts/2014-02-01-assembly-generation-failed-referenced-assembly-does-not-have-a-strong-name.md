...
![Assembly generation failed - Referenced assembly does not have a strong name]({{ site.url }}{{ site.baseurl }}/assets/images/2014/02/assembly_generation_failed_error.png)
