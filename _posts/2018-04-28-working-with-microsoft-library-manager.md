...
![LibMan downloading files from cdnjs]({{ site.url }}{{ site.baseurl }}/assets/images/2018/04/libman_downloading_files.png)
...
![LibMan build error]({{ site.url }}{{ site.baseurl }}/assets/images/2018/04/libman_error.png)
