...
![Publish Profile in GitHub Secrets]({{ site.url }}{{ site.baseurl }}/assets/images/2019/09/publish_profile.png)
...
![App Service deployment]({{ site.url }}{{ site.baseurl }}/assets/images/2019/09/azure_app_service.png)
