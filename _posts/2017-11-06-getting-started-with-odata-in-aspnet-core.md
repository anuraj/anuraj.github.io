...
![ASP.NET Core OData Package]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/aspnetcore_odata_package.png)
...
![OData endpoint from Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/postman_odata_endpoint.png)

And here is the output of $metadata endpoint.

![OData Metadata endpoint]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/metadata_endpoint.png)
...
![OData endpoint from Postman]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/invalid_oper_exception.png)
...
![Serialization exception - OData SingleResult]({{ site.url }}{{ site.baseurl }}/assets/images/2017/11/serialization_exception.png)
