...
![Azure Logic App]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/azure_logic_app.png)

Once you clicked on Create button, Create Logic App blade will open up. You can provide the name and other details.

![Create Azure Logic App]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/create_logic_app.png)
...
![Logic App Designer]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/logic_app_designer.png)
...
![Logic App Designer - HTTP API]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/http_step1.png)
...
![Condition option]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/codition_option.png)
...
![Send email action]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/send_email_action.png)
...
![Email from Logic App]({{ site.url }}{{ site.baseurl }}/assets/images/2016/12/email_from_logic_app.png)
