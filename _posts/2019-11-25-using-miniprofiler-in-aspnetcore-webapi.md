...
![MiniProfiler Results in ASP.NET Core Web API]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/miniprofiler_results_page.png)
...
![More detailed Profiling]({{ site.url }}{{ site.baseurl }}/assets/images/2019/11/miniprofile_more_details.png)
