...
![Bundling and Minification using Smidge]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/bundle_minify_output.png)
...
![Rendering the actual files instead of bundled version]({{ site.url }}{{ site.baseurl }}/assets/images/2017/12/rendering_files.png)
