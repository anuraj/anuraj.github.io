...
![Creating the SQL Server Docker image with database]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/sqlserver_init.png)
...
![SQL Server Management studio connecting to SQL Server docker container]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/sqlserver_ssms.png)
