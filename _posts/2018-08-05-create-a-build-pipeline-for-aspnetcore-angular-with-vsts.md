...
![Select repository option in VSTS]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/select_repository.png)
...
![ASP.NET Core project template selection]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/aspnetcore_template.png)
...
![ASP.NET Core Default Steps]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/aspnetcore_default_steps.png)
...
![npm command]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/npm_command_step.png)
...
![npm command - npm install]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/npm_install.png)
...
![package.json scripts]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/package_json_scripts.png)

You need to provide this command in the `Command and arguments` option like this `run build`.

![npm build step]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/npm_build_step.png)

You can do the same steps for running a `ng lint` command as well.

Here is my complete build setup.

![Build Setup]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/build_setup.png)

And here is the log after completing the build.

![Build Summary]({{ site.url }}{{ site.baseurl }}/assets/images/2018/08/build_summary.png)
