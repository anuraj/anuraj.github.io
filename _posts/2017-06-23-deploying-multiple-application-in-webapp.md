...
![Virtual applications and directories]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/Azure_Virtual_applications.png)
...
![Edit Profile settings]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/publish_profile.png)

Once you did that you can open it and it will publish the app to the specific virtual directory.

![Settings - Publish Profile]({{ site.url }}{{ site.baseurl }}/assets/images/2017/06/publish_settings.png)
