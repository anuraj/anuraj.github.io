...
![dotnet restore command output]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/dotnet_restore_command.png)
...
![dotnet publish command output]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/dotnet_publish_command.png)

Once publish is completed, you will be able to see the files under publish folder.

![dotnet publish - Windows Explorer]({{ site.url }}{{ site.baseurl }}/assets/images/2017/10/publish_folder.png)
