...
![Application Structure]({{ site.url }}{{ site.baseurl }}/assets/images/2018/02/app_structure.png)
...
![Select Source - GitHub]({{ site.url }}{{ site.baseurl }}/assets/images/2018/02/select_source.png)
...
![Deployment options]({{ site.url }}{{ site.baseurl }}/assets/images/2018/02/deployment_options.png)
...
![Kudu script - Help]({{ site.url }}{{ site.baseurl }}/assets/images/2018/02/kuduscript-help.png)
...
![Deployment options - Deployment Status]({{ site.url }}{{ site.baseurl }}/assets/images/2018/02/status_of_deployment.png)

Once it is successful, you will be able to the status and detailed log, when you click on the deployment.

![Deployment options - Deployment Details]({{ site.url }}{{ site.baseurl }}/assets/images/2018/02/deployment_details.png)
