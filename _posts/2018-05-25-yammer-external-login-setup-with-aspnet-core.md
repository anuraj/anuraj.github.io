...
![Creating a new Yammer App]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/new_yammer_app.png)
...
![Creating a new Yammer App]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/yammer_app_details.png)
...
![Yammer authentication dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/yammer_auth_dialog.png)

Once you provide the credentials and click Login, you will be redirected to the authorization dialog, like this.

![Yammer authorization dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/yammer_auth_dialog2.png)
...
![Yammer Authentication Exception]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/yammer_auth_error.png)
...
![Application with Logged in user name]({{ site.url }}{{ site.baseurl }}/assets/images/2018/05/yammer_aspnet_app.png)
