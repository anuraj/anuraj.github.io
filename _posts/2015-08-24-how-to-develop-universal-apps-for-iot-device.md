...
![Windows 10 - Enable Developer mode]({{ site.url }}{{ site.baseurl }}/assets/images/2015/08/developersettings.png)
...
![Remote machine settings]({{ site.url }}{{ site.baseurl }}/assets/images/2015/08/remotemachine.png)
