...
![ASPNET Core Application with DropzoneJS for Drag and Drop file upload]({{ site.url }}{{ site.baseurl }}/assets/images/2016/04/aspnetcore_running_with_dropzone.png)
