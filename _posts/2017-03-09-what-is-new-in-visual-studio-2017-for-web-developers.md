...
![ASP.NET Core - New Project dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/aspnet_core_new_project.png)
...
![ASP.NET Core Web API Project]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/web_api_project.png)
...
![Edit Project - Context Menu]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/edit_project_file.png)

The new CSProj format is simpler, there is no GUIDs :) 

![CSProj format]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/csproj_format.png)
...
![dotnet new command]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/dotnet_new_command.png)
...
![Enable Chrome Debugging in Visual Studio 2017]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/debugging_with_chrome.png)
...
![Javascript debugging wih Chrome]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/chrome_debugging_launching.png)
