...
![Building the Docker Image]({{ site.url }}{{ site.baseurl }}/assets/images/2017/02/docker_build.png)
...
![Publishing the Docker Image to Heroku]({{ site.url }}{{ site.baseurl }}/assets/images/2017/02/docker_image_publish.png)
...
![View Logs option in Heroku]({{ site.url }}{{ site.baseurl }}/assets/images/2017/02/viewlogs_option_in_heroku.png)
...
![Running dynos in Heroku]({{ site.url }}{{ site.baseurl }}/assets/images/2017/02/heroku_dyno_config.png)
