...
![New Visual Studio project with Individual User Accounts authentication mode]({{ site.url }}{{ site.baseurl }}/assets/images/2016/10/change_auth_mode.png)
...
![Scaffolded Menu item]({{ site.url }}{{ site.baseurl }}/assets/images/2016/10/scaffolded_item_contextmenu.png)
...
![Add Scaffold dialog]({{ site.url }}{{ site.baseurl }}/assets/images/2016/10/add_scaffold_dialog.png)
...
![Command line scaffolding]({{ site.url }}{{ site.baseurl }}/assets/images/2016/10/commandline_scaffolding.png)
