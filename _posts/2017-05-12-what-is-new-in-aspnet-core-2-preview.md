...
![ASP.NET Core 2.0 Preview - Solution Explorer]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/aspnet_core2_solution_explorer.png)
...
![ASP.NET Core 2.0 Preview - Add new Razor Page]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/add_new_razor_page.png)
...
![ASP.NET Core 2.0 - Integrated Azure Application Insights and diagnostics ]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/application_insights_menu.png)
...
![Visual Basic Support added]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/visualbasic_support_for_dotnet_core.png)
...
![ASP.NET Core 2.0 New Project]({{ site.url }}{{ site.baseurl }}/assets/images/2017/05/aspnet_core_2_newproject.png)
