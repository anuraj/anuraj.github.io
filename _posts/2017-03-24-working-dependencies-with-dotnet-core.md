...
![dotnet add command Help]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/dotnet_add_command.png)
...
![dotnet add EF Core]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/dotnet_add_command_ef_core.png)

You can remove the reference similar way, so instead of add you need to use the remove command.

![dotnet remove]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/dotnet_remove_command.png)
...
![dotnet add project reference]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/dotnet_add_reference.png)
