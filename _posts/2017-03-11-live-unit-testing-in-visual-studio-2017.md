...
![Install Live Unit Testing]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/enable_live_unit_testing.png)
...
![Start Live Unit Testing]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/liveunittesting_start.png)

Once Live Unit Testing started, you can the various status in the Visual Studio editor.

![Running Live Unit Testing]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/live_unit_test_running.png)
...
![Live Unit Testing - Popup]({{ site.url }}{{ site.baseurl }}/assets/images/2017/03/lut_icon_testpopup.png)
