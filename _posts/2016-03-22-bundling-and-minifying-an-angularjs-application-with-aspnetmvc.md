...
![Angular Minification Error]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/angular_error_script_file_order.png)

If you look at the HTML source, you will find something like this.

![Angular Script Order]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/angular_script_order.png)
...
![Angular Script Order fixed]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/angular_script_order_fixed.png)
...
![Angular DI Error]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/angular_di_error.png)

And if you look at the source code of the combined javascript file, you could see something like this.

![Angular Scope variable renamed]({{ site.url }}{{ site.baseurl }}/assets/images/2016/03/scope_variable_renamed.png)
