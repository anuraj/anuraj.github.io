...
![NUnit tests running on dotnet core]({{ site.url }}{{ site.baseurl }}/assets/images/2017/01/nunit_test_running.png)
...
![NUnit tests running on dotnet core on specific Category]({{ site.url }}{{ site.baseurl }}/assets/images/2017/01/nunit_test_running_category.png)
