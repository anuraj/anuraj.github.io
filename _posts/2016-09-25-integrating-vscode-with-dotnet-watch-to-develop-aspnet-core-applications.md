...
![dotnet watch command line feature]({{ site.url }}{{ site.baseurl }}/assets/images/2016/09/dotnet_watch_command_line.png)
...
![Required assets to build and debug Install prompt]({{ site.url }}{{ site.baseurl }}/assets/images/2016/09/vscode_debugging_assets.png)
