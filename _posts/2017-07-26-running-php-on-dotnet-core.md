...
![PHP running on ASP.NET Core]({{ site.url }}{{ site.baseurl }}/assets/images/2017/07/php_running_in_aspnet_core.png)
...
![Peachpie for Visual Studio Code]({{ site.url }}{{ site.baseurl }}/assets/images/2017/07/peachpiestudio_vscode.png)

Note : When I tried to restore the dependencies first time. I got an error like this.

![dotnet restore error]({{ site.url }}{{ site.baseurl }}/assets/images/2017/07/dotnet_restore_error.png)
