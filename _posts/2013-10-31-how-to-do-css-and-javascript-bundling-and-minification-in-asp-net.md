...
![Network Traffic without Bundling and Minification]({{ site.url }}{{ site.baseurl }}/assets/images/2013/10/download_without_bundling.png)

And here is the same web application after enabling css and javascript bundling and minification.

![Network Traffic with Bundling and Minification]({{ site.url }}{{ site.baseurl }}/assets/images/2013/10/download_with_bundling.png)
