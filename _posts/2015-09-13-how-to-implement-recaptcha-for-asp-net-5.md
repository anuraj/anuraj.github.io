...
![reCaptcha Registration ]({{ site.url }}{{ site.baseurl }}/assets/images/2015/09/reCaptchaReg.png)

Once it is completed, you will get a screen like this.

![reCaptcha - Dashboard]({{ site.url }}{{ site.baseurl }}/assets/images/2015/09/reCaptchaReg2.png)
...
![recaptcha running]({{ site.url }}{{ site.baseurl }}/assets/images/2015/09/webpage.png)
