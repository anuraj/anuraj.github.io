...
![Visual Studio IntelliCode extension]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/vsIntelliCode.png)
...
![Visual Studio IntelliCode suggestions]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/intellicode_display.png)
...
![Visual Studio IntelliCode - Prompt]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/intellicode_prompt.png)

And clicking on Try it now will display a screen like this.

![Visual Studio IntelliCode - Train model]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/intellicode_model.png)
...
![Visual Studio IntelliCode - Train model]({{ site.url }}{{ site.baseurl }}/assets/images/2018/12/trained_model.png)
