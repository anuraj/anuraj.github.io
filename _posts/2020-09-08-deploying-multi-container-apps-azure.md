...
![Create Web App]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/create_web_app.png)
...
![Create Web App - Docker configuration]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/create_web_app_docker.png)
...
![Container Settings]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/container_settings.png)
...
![Log Stream Information]({{ site.url }}{{ site.baseurl }}/assets/images/2020/09/log_stream.png)
